...
Заменяет GameObject левой руки. Если объект не передан, отключает модель руки. (Отключается именно модель старой руки, функции остаются, при необходимости, блокируйте стандартный ввод, см. BlockInput)
...
Заменяет GameObject правой руки. Если объект не передан, отключает модель руки. (Отключается именно модель старой руки, функции остаются, при необходимости, блокируйте стандартный ввод, см. BlockInput)
