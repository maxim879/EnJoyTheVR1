...
Создание игры для EnJoyTheVR схоже с созданием обычной игры, однако в связи с ограничением бандлов Unity скрипты должны быть написаны на Lua. Однако в проекте уже присутсвуют некоторые ассеты, которые могут быть использованы, как готовое решение для некоторых решений.
